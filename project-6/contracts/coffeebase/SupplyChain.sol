    ...
    Ownable
{
    ...
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "Caller is not address");
        _;
    }

    // Define a modifier that checks if the paid amount is sufficient to cover the price
    modifier paidEnough(uint256 _price) {
        require(msg.value >= _price, "Value is lower then requested price");
        _;
    }
    ...
    modifier harvested(uint256 _upc) {
        require(
            ...
            "State of the item is not harvested"
        );
        _;
    }
    ...
    modifier processed(uint256 _upc) {
        require(
            ...
            "State of the item is not processed"
        );
        _;
    }
    ...
    modifier packed(uint256 _upc) {
        require(
            ...
            "State of the item is not packed"
        );
        _;
    }
    ...
    modifier forSale(uint256 _upc) {
        require(
            ...
            "State of the item is not for sale"
        );
        _;
    }
    ...
    modifier shipped(uint256 _upc) {
        require(
            ...
            "State of the item is not shipped"
        );
        _;
    }
    ...
    modifier received(uint256 _upc) {
        require(
            ...
            "State of the item is not received"
        );
        _;
    }
    ...
    modifier purchased(uint256 _upc) {
        require(
            ...
            "State of the item is not purchased"
        );
        _;
    }

    modifier itemDoesNotExist(uint256 _upc) {
        require(
            items[_upc].ownerID == address(0),
    ...
    ) public verifyCaller(_originFarmerID) onlyFarmer() itemDoesNotExist(_upc) {
